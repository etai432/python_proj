...
class Game:
        ...
        for i in self.empty:
            for j in range(4):
                for g in range(2):
                    ...
                    score = self.model.predict(copy_board)
                    if score > max1:
    ...
    def play_one_game_ai(self):
        ...
        while True:
            ...
            last_index = self.rotate_board(self.quarter, self.direction, self.board)
            if turns > 9 and self.check_win(last_index, turn) == 2:
                return 2
            turn = 0
            turns += 1
    ...
    def run_games_ai(self):
        ...
        for i in range(10000):
            ...
            if winner == 2:
                ...
                ties += 1
        print("player x won: " + str(wins1 / 100) + "%")
        print("player o won: " + str(wins2 / 100) + "%")
        print("a tie happened " + str(ties / 100) + "% of the time")
...
def main():
    ...
    game.run_games_ai()
    # game.run_games()
    # with open('pentago_dict.csv', 'w') as csv_file:
